...
function todosGenerator(todosList) {
    ...
    todosList.forEach(function (todo) {
        ...
        newTodoCompleteBtn.innerHTML = 'کامل'
        newTodoCompleteBtn.style = 'margin-right: 8rem;'
        ...
        if (todo.complete) {
            ...
            newTodoCompleteBtn.innerHTML = 'ناقص'
            newTodoLiElem.style = 'background-color: rgb(79, 78, 78);'
        }
